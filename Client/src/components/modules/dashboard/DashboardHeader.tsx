...
const DashboardHeader = ({ activeTab, onTabChange }: DashboardHeaderProps) => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#214f3b] via-[#0F2027] to-[#193a36] relative overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-full opacity-40">
        <img
          alt=""
          className="w-72 absolute opacity-60 right-20 top-20 object-cover"
          src={bg.src}
        />
      </div>
      ...
      >
        ...
        {/* Mobile Menu */}
        <NavbarMenu className="bg-gradient-to-br from-[#214f3b]/95 via-[#0F2027]/95 to-[#193a36]/95 backdrop-blur-md border-t border-white/10">
          <div className="flex flex-col gap-2 py-4">
            ...
            <NavbarMenuItem className="px-4">
              <button
                ...
                onClick={() => handleMobileTabChange("tasklist")}
              >
                <div
                  className={`p-2 rounded-lg ${
                    activeTab === "tasklist" ? "bg-white/20" : "bg-white/10"
                  }`}
                >
                  <svg
                    fill="none"
                ...
                <div className="flex-1 text-left">
                  <div className="font-semibold text-base">Task List</div>
                  <div className="text-sm text-white/60">Manage your tasks</div>
                </div>
                {activeTab === "tasklist" && (
            ...
            <NavbarMenuItem className="px-4">
              <button
                ...
                onClick={() => handleMobileTabChange("spin")}
              >
                <div
                  className={`p-2 rounded-lg ${
                    activeTab === "spin" ? "bg-white/20" : "bg-white/10"
                  }`}
                >
                  <svg
                    fill="none"
                ...
                <div className="flex-1 text-left">
                  <div className="font-semibold text-base">Spin Wheel</div>
            ...
            {/* Divider */}
            <div className="mx-4 my-4 h-px bg-white/20" />
            ...
            <div className="px-4">
              <div className="flex items-center gap-3 p-4 bg-white/10 rounded-xl">
                ...
                <button className="p-2 rounded-lg bg-red-500/20 text-red-300 hover:bg-red-500/30 transition-colors"
                  title="Logout"
      ...
      <div className="relative z-10 px-4 py-6 lg:py-24 sm:px-6 lg:px-8">
